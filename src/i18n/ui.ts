...
export const ui = {
	'zh-cn': {
		...
		backToTravel: '返回旅行',
		traveledOn: '出发于',
		travelJournalTitle: '我的旅行手帐',
		yearExplorations: '{year} 探索',
		yearJourneys: '{year} 旅程',
		tripNotes: '行程笔记',
		durationDays: '{n} 天',
		photos: '照片',
		videos: '视频',
		map: '地图',
		travelTimeline: '行程时间线',
	...
	en: {
		...
		traveledOn: 'Traveled',
		travelJournalTitle: 'My Travel Journal',
		yearExplorations: '{year} EXPLORATIONS',
		yearJourneys: '{year} JOURNEYS',
